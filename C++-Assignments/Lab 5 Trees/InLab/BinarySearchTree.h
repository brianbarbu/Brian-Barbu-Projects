...
class BinarySearchTree {
 ...
 private:
  ...
  BinaryNode* insert(BinaryNode *&select, const string& x);
  ...
  string map(BinaryNode *select, const string& x) const;
  bool deepfind(BinaryNode *select, const string& x) const;
  int count;
};
